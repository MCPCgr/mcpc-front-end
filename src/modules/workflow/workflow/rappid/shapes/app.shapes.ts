  ...
  fromStencilShape: function (element: dia.Element) {
    ...
    const attrs = {
      subject: {
        ...
        company_id: element.attr(['subject', 'company_id']),
        struct_id: element.attr(['subject', 'struct_id']),
        job_id: element.attr(['subject', 'job_id']),
        emp_id: element.attr(['subject', 'emp_id']),
