  ...
  <div>
    ...
    <label>Хариуцагчийн төрөл
      ...
      <a-radio-group
        ...
        <a-radio value="ANY_EMP">Хэн нэг ажилтан</a-radio>
        <a-radio  value="VOTERS">Санал өгөгчид</a-radio>
        <a-radio  value="TO_ORG_STRUCT">Алба хэлтэс</a-radio>
        <a-radio  value="TO_ORG_JOB">Албан тушаал</a-radio>
        <a-radio  value="TO_ORG_EMPLOYEE">Ажилтан</a-radio>
...
<!--        <a-radio  value="DIRECT">Системийн хэрэглэгч</a-radio>-->
    ...
    <div v-if="subject_type === 'TO_ORG_STRUCT'">
      <OrgStructEmployeeSelector  v-model:company_id="company_id" v-model:struct_id="struct_id" v-model:job_id="job_id" v-model:emp_id="emp_id"  @change="changeOrg" mode="TO_ORG_STRUCT"/>
    </div>
    <div v-if="subject_type === 'TO_ORG_JOB'">
      <OrgStructEmployeeSelector v-model:company_id="company_id" v-model:struct_id="struct_id" v-model:job_id="job_id" v-model:emp_id="emp_id"  @change="changeOrg" mode="TO_ORG_JOB"/>
    </div>
    <div v-if="subject_type === 'TO_ORG_EMPLOYEE'">
      <OrgStructEmployeeSelector v-model:company_id="company_id" v-model:struct_id="struct_id" v-model:job_id="job_id" v-model:emp_id="emp_id"  @change="changeOrg" mode="TO_ORG_EMPLOYEE"/>
    </div>
...
const cellProps = {
  ...
  company_id: ['attrs', 'subject', 'company_id'],
  struct_id: ['attrs', 'subject', 'struct_id'],
  job_id: ['attrs', 'subject', 'job_id'],
  emp_id: ['attrs', 'subject', 'emp_id'],
...
const assignFormFields = () => {
  ...
  company_id.value = props.cell.prop(cellProps.company_id);
  struct_id.value = props.cell.prop(cellProps.struct_id);
  job_id.value = props.cell.prop(cellProps.job_id);
  emp_id.value = props.cell.prop(cellProps.emp_id);
...
const changeStructEmp = (structEmp) => {
  ...
  changeCellProp(cellProps.company_id, structEmp.company_id)
  changeCellProp(cellProps.struct_id, structEmp.struct_id)
  changeCellProp(cellProps.job_id, structEmp.job_id)
  changeCellProp(cellProps.emp_id, structEmp.emp_id)
}
const changeOrg = (emp) => {
  changeCellProp(cellProps.company_id, emp.company_id)
  changeCellProp(cellProps.struct_id, emp.struct_id)
  changeCellProp(cellProps.job_id, emp.job_id)
  changeCellProp(cellProps.emp_id, emp.emp_id)
}
