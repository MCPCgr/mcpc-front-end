    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8">
      ...
      <div class="bg-white rounded-xl p-6 dashboard_shadow ">
        <div class="text-sm font-semibold text-second_color ">
          Ажилтан салбар нэгжээр
          <Chart src="https://api.amjilt.com/main/lambda/puzzle/schema-public/chart/994" projectDomain="https://api.amjilt.com/main" :hideTitle="true" :filters="companyFilter"></Chart>
        </div>
      </div>
      <!-- Даатгуулагчийн төрлөөр -->
      <div class="bg-white rounded-xl p-6 dashboard_shadow ">
        <div class="text-sm font-semibold text-second_color ">Даатгуулагчийн төрлөөр
          <Chart src="https://api.amjilt.com/main/lambda/puzzle/schema-public/chart/988" projectDomain="https://api.amjilt.com/main" :hideTitle="true" :filters="companyFilter" :labels="insured_types"></Chart>
        </div>
      </div>
      ...
      <div class="bg-white rounded-xl p-6 dashboard_shadow ">
        <div class="text-sm font-semibold text-second_color ">Ажилласан хугацаагаар
          ...
          <Chart src="https://api.amjilt.com/main/lambda/puzzle/schema-public/chart/990" projectDomain="https://api.amjilt.com/main" :hideTitle="true" :filters="companyFilter" ></Chart>
      ...
      <div class="bg-white rounded-xl p-6 dashboard_shadow h-full">
        <div class="text-sm font-semibold text-second_color ">Ажилтны төрлөөр
          <Chart src="https://api.amjilt.com/main/lambda/puzzle/schema-public/chart/991" projectDomain="https://api.amjilt.com/main" :hideTitle="true" :filters="companyFilter" ></Chart>
      ...
      <div class="bg-white rounded-xl p-6 dashboard_shadow h-full">
        <div class="text-sm font-semibold text-second_color ">Ажилтан боловсролоор
          <Chart src="https://api.amjilt.com/main/lambda/puzzle/schema-public/chart/992" projectDomain="https://api.amjilt.com/main" :hideTitle="true" :filters="companyFilter" ></Chart>
