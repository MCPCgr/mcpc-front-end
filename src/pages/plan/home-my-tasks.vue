    ...
    <div>
      <div class="flex justify-between">
        <div class="text-sm text-gray-500 dark:text-gray-400 font-normal">
          Танд нийт: <span class="font-bold text-primary-color dark:text-white">{{tasks.length}}</span> ажил байна
        </div>
<!--        <div>-->
<!--          Эрэмлэлт: <a-select-->
...
import HomeTaskCard from "~~/plan/Kanban/components/HomeTaskCard.vue";


export default {
  name: "home-my-tasks",
  mixins: [pageMixin, projectMixin],
  components: {HomeTaskCard, TaskForm, PMTopMenu, myTaskSkeleton, TaskCard},
  data() {
    return {
      projects:[],
      tasks:[],
