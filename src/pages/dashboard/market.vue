<template>
  <div>
    <Head>
      <Title>Борлуулалт, бараа материал</Title>
    </Head>
    ...
    <portal to="header-left">
      <div className="page-title float-left">
        <div className="float-left pt-3">
          <h1 className="text-gray-700 dark:text-gray-200 text-base m-0 ">Борлуулалт, бараа материал</h1>
          <h2 className="text-gray-400 text-xs m-0"><span>Хяналтын самбар</span></h2>
        </div>
      </div>
    </portal>
    <div className="dashboard_tab">
      <Market :structs="rawStructs"/>
    </div>
  </div>
</template>
