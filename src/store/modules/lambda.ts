...
export const lambda ={
  ...
  mutations: {
    [LAMBDA_CONFIG]: (state: { config: any }, config: any) => {
      state.config = config
    },
    [KRUDS]: (state: { kruds: any }, kruds: any) => {
      state.kruds = kruds
    },
    [MENU]: (state: { menu: any }, menu: any) => {
      state.menu = menu
    },
    [PERMISSIONS]: (state: { permissions: any }, permissions: any) => {
      state.permissions = permissions
    },
    [MENU_LIST]: (state: { menu_list: any }, menu_list: any) => {
      state.menu_list = menu_list
    },
    [SAVED_TABS]: (state: { saved_tabs: any }, saved_tabs: any) => {
