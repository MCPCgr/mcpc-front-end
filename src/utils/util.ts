...
import { PERMISSIONS, MENU_NAV, MENU, KRUDS, MENU_LIST } from '~/store/mutation-types'
import {COMPANY, COMPANIES, LMS_ROLES} from '~/store/mutation-types-tatatonga'
import {ClearToken} from "~/plugins/core/axios";
